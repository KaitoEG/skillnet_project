...
import './Login.css'; // O utiliza el mismo CSS que usabas en App.css, si corresponde
  ...
  return (
    <div className='contiene'>
      <div className="login-container">
        <img src={Logo1} alt="Logo SkillNet" />
      </div>
      <div className="login-form">
        <div className='cubiculo'>
          ...
          {/* Si deseas redirigir a Home al iniciar sesión, puedes incluir un Link: */}
